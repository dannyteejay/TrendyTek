    ...
    <div className="pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100">
      ...
      <div className="flex flex-col gap-12 sm:gap-12 sm:flex-row">
        ...
        <div className="flex-1">
              ...
              <div className="flex gap-2">
                {productData.sizes.map((item, index) => (
                  <button
                    ...
                    className={`border py-2 px-4 bg-gray-100 rounded-md cursor-pointer transition-all ${
                      item === size
          ...
          <button
            ...
            className="px-8 py-3 text-sm font-bold text-white uppercase bg-black hover:bg-gray-800 active:scale-95 transition-all shadow-md rounded-lg cursor-pointer mt-4"
          >
            ADD TO CART 🛒
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 px-6 py-6 text-sm text-gray-500 border">
          <p>
            Elevate your lifestyle with our meticulously curated TrendyTek products.
            Designed with a perfect balance of quality, reliability, and modern convenience,
            these products are made to exceed your expectations.
          </p>
          <p>
            Experience superior craftsmanship and effortless ordering with fast doorstep delivery
            backed by TrendyTek's verified guarantee.
          </p>
        </div>
      </div>
